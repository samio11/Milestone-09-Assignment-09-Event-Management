        ...
        <div>
            ...
            <div className="mt-5">
                ...
                <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-2 mt-5">
                    <div className="w-full md:w-[65%] grid grid-cols-1 md:grid-cols-3 gap-3" data-aos="fade-right">
                        {
                            data?.map(x => <HomeCard key={x.id} data={x}></HomeCard>)
                        }
                    </div>
                    <div className="w-full md:w-[30%] flex justify-center items-center" data-aos="fade-left">
            ...
            <div className="mt-5">
                <h2 className="text-center text-xl font-semibold">Our WorkShop and Location</h2>
                <div className="mt-5 flex flex-col md:flex-row justify-between items-center">
                    <div className="flex-1" data-aos="fade-right">
                        <Lottie animationData={location}></Lottie>
                    </div>
                    <div className="flex-1 flex justify-center items-center" data-aos="flip-right">
                        <div>
                            <p className="font-semibold text-xl">Email:- samiohasan6@gmail.com</p>
                            <p className="font-semibold text-xl">Location:- Nikunja-02,Khilhhet,Dhaka</p>
                        </div>
                    </div>
                </div>
            </div>
            {/* Faq  */}
            <div className="mt-5">
                <h2 className="text-center text-xl font-semibold">FAQ</h2>
                    ...
                    <div className="flex-1" data-aos="fade-right">
                        <div className="collapse collapse-arrow bg-base-200">
                            ...
                            <div className="collapse-content">
                                <p>The event is scheduled to take place on [dates] and will be hosted virtually on our website. You can access it from anywhere with an internet connection.</p>
                            </div>
                        </div>
                        <div className="collapse collapse-arrow bg-base-200">
                            <input type="radio" name="my-accordion-2" />
                            <div className="collapse-title text-xl font-medium">
                            Are there discounts for early bird registration?
                            </div>
                            <div className="collapse-content">
                                <p> Yes, we offer early bird discounts for those who register before [early bird deadline]. Take advantage of reduced rates by registering early and securing your spot at the event.</p>
                            </div>
                        </div>
                        <div className="collapse collapse-arrow bg-base-200">
                            <input type="radio" name="my-accordion-2" />
                            ...
                            <div className="collapse-content">
                                <p>Stay informed by checking the Latest News/Announcements section on our website. You can also subscribe to our newsletter for regular updates, exclusive content, and important announcements.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex-1 flex justify-center items-center" data-aos="flip-right">
                        <div>
                            <Lottie className="h-[400px]" animationData={faq}></Lottie>
                        </div>
                    </div>
                </div>
            </div>
